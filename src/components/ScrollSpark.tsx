...
export default function ScrollSpark() {
  ...
  useEffect(() => {
    ...
    const getAccent = () => {
      ...
      return theme === "accent" ? "#c9daed" : "#ffffff";
    };
    ...
    const burst = (x: number, y: number, scrollDelta: number) => {
      ...
      requestAnimationFrame(() => {
        ...
        const atBottom =
          window.scrollY + window.innerHeight >=
            document.documentElement.scrollHeight - 1 && delta > 0;
