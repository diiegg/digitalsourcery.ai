...
export default function ProcessSection() {
  return (
    <section id="process" style={{ paddingTop: "var(--fib-7)", paddingBottom: "var(--fib-7)", backgroundColor: "var(--color-ds-card)", borderTop: "1px solid var(--color-ds-border)", borderBottom: "1px solid var(--color-ds-border)" }}>
