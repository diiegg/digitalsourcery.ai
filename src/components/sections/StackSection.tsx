  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-[var(--fib-5)]">
        {/* Section header — reference pattern: heading + line + subtitle */}
        <motion.div
        ...
        >
          ...
          <p
            ...
            style={{ fontSize: "var(--text-fib-base)", marginTop: "var(--fib-2)" }}
          >
            Tested tools and real-world benchmarks from our core production audits.
          </p>
        </motion.div>

        {/* 2x2 grid — perfectly balanced, no orphans */}
        <motion.div
          variants={stagger}
          initial="hidden"
          whileInView="visible"
          ...
          {verdicts.map((v) => (
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "var(--text-fib-xs)", color: "var(--color-ds-warm-dim)", marginBottom: "var(--fib-4)" }}
              >
                Tested: {v.tested}
              </p>
              <p
